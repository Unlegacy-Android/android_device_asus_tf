...
#define MIXER_CARD 1
#define MIXER_XML_RT5631 "/system/etc/mixer_rt5631.xml"
#define MIXER_XML_WM8903 "/system/etc/mixer_wm8903.xml"
                     ...
                     hw_device_t** device)
{
    ...
    switch(device_switch()) {
        ...
        case 0x04:  // TF700T
        case 0x05:  // TF300TL
            adev->ar = audio_route_init(MIXER_CARD, MIXER_XML_RT5631);
            break;

        case 0x02:  // TF300T
            adev->ar = audio_route_init(MIXER_CARD, MIXER_XML_WM8903);
            break;
