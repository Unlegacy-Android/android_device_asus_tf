...
/*NvBool*/ void NvOdmImagerGetDevices(NvS32 *pCount, int *phImagers){
...
/*NvBool*/ void NvOdmImagerOpen(NvU64 ImagerGUID, int *phImager) {
...
/*NvBool*/ void NvOdmImagerSetSensorMode(int hImager, const int *pParameters,
				int *pSelectedMode, int *pResult) {
	ALOGI("NvOdmImagerSetSensorMode is called\n");
}

/*NvBool*/ void NvOdmImagerSetPowerLevel(int hImager, int Devices, int PowerLevel) {
	ALOGI("NvOdmImagerSetPowerLevel is called\n");
}

/*NvBool*/ void NvOdmImagerSetParameter(int hImager, int Param,
				NvS32 SizeOfValue, const void *pValue) {
	ALOGI("NvOdmImagerSetParameter is called\n");
}

/*NvBool*/ void NvOdmImagerGetParameter(int hImager, int Param,
